...
/**
 * This class represents one color channel of an image. It is package-visible
 * for a reason. Do not make it public.
 * 
 * @author gavin
 */
class Channel {
	...
	/**
	 * Basic constructor that contructs a channel for an image of the provided
	 * width and height.
	 * 
	 * @param width
	 *            the image width.
	...
	/**
	 * Validates coordinates from the user. Throws an Exception with an
	 * appropriate message if they are not valid.
	 * 
	 * @param x
	...
	/**
	 * Validates data from the user. Throws an Exception with an appropriate
