...
public abstract class CS355Image extends Observable {
	...
	/**
	 * A constructor that creates an Image of a certain size. It is initialized
	 * to default black.
	 * 
	 * @param width
	...
	/**
	 * Called from the ViewRefresher to get a BufferedImage for drawing. I would
	 * suggest that you make this as efficient as possible, or maybe you could
	 * try to only call it when necessary.
	 * 
	 ...
	 * 
	 * @param amount
	 *            the amount of contrast to add (could be negative).
	 */
	 ...
	 * 
	 * @param amount
	 *            the amount of brightness to add (could be negative).
	 */
	...
	/**
	 * Sets the data in this image to be the same as the provided CS355Image. Be
	 * warned: this does a shallow copy.
	 * 
	 * @param img
	 *            the CS355Image to copy.
	 */
	...
	/**
	 * Sets the pixels according to the BufferedImage. This basically
	 * initializes the image.
	 * 
	 * @param bi
	 *            the BufferedImage whose data we want.
	 */
	 ...
	 * @param data
	 *            an array of 3+ ints to hold the data. If null or too small, an
	 *            array will be allocated and returned. Otherwise, data will be
	 *            filled and returned.
	...
	/**
	 * Set a pixel's channels with the provided data. This method doesn't care
	 * if the provided array has a length greater than 3, but it will throw an
	 * exception if the length is less.
	 * 
	 * @param x
	 ...
	 * @param data
	 *            the data to put in the channels.
	 */
	 ...
	 * 
	 * @param width
	 *            the width of the image to allocate.
	 * @param height
	 *            the height of the image to allocate.
	 */
	private void initPixels(int width, int height) {
		...
		// Create the channels.
		pixels = new Channel[] { new Channel(width, height), new Channel(width, height), new Channel(width, height) };
	}
}
