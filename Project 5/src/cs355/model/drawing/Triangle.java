...
public class Triangle extends Shape {
	...
	public Triangle(Double a, Double b, Double c) {
		this(Color.white, new Point2D.Double(), a,b,c); 
	}
	...
	public boolean pointInShape(Point2D.Double pt, double tolerance) {
		boolean side1Positive, side2Positive, side3Positive;
		side1Positive=(sameSide(pt,a,b)>0);
		side2Positive=(sameSide(pt,b,c)>0);
		side3Positive=(sameSide(pt,c,a)>0);
		return ((side1Positive==side2Positive)&(side3Positive==side2Positive));
	}
	private double sameSide(Point2D.Double pt,
			Point2D.Double ptX, Point2D.Double ptY){
