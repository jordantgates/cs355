...
/**
 * This is the main window of the app. This implements MouseListener and
 * MouseMotionListener, even though technically, the student's CS355Controller
 * should. Doing so allows the frame to capture mouse events that should update
...
class CS355Frame extends javax.swing.JFrame implements KeyListener, MouseListener, MouseMotionListener {
	...
	/**
	 * Returns the static instance of the frame. Used because the constructor is
	 * private.
	 * 
	...
	/**
	 * The private constructor. It needs to initialize all of the frame's
	 * internal components, as well as the RedrawRoutine.
	 * 
	 * @param c
	 *            = an instance of the student's CS355Controller.
	 * @param v
	 *            = an instance of the student's ViewRefresher.
	 */
	...
	/**
	 * This method is just so we don't "leak this" (NetBeans' term, not mine) in
	 * the constructor. Always call this right after creating the frame.
	 */
	public void start() {
	...
	private void initComponents() {
		...
		coordLbl.setFont(new java.awt.Font("Courier New", 1, 15)); // NOI18N
		coordLbl.setText("[ -1, -1]");

		zoomLbl.setFont(new java.awt.Font("Courier New", 1, 15)); // NOI18N
		zoomLbl.setText("100%");

		debugLbl.setFont(new java.awt.Font("Courier New", 1, 15)); // NOI18N
				...
				layout.createSequentialGroup().addContainerGap().addGroup(layout
						...
						.addGroup(layout.createSequentialGroup()
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
										.addComponent(zoomInBtn, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(selectBtn, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(triangleBtn, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(ellipseBtn, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(circleBtn, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(rectBtn, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(squareBtn, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(lineBtn, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(colorBtn, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(zoomOutBtn, javax.swing.GroupLayout.Alignment.TRAILING,
						...
						.addGroup(layout.createSequentialGroup()
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addComponent(imageBtn, javax.swing.GroupLayout.Alignment.TRAILING,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(houseBtn, javax.swing.GroupLayout.Alignment.TRAILING,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)))
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
								.addComponent(vertScrollBar, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(colorCanvas, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(horScrollBar, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addGroup(layout.createSequentialGroup()
										.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
												...
												.addGroup(layout.createSequentialGroup().addComponent(zoomLbl)
														.addPreferredGap(
																javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
														.addComponent(coordLbl)
														.addPreferredGap(
																javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
														.addComponent(debugLbl, javax.swing.GroupLayout.PREFERRED_SIZE,
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
						...
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
								.addComponent(horScrollBar, javax.swing.GroupLayout.PREFERRED_SIZE,
						...
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addGroup(layout.createSequentialGroup()
										.addComponent(canvas, javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
												.addComponent(coordLbl).addComponent(zoomLbl).addComponent(debugLbl,
														javax.swing.GroupLayout.PREFERRED_SIZE, 18,
														javax.swing.GroupLayout.PREFERRED_SIZE))))
						.addContainerGap())
						.addGroup(layout.createSequentialGroup().addComponent(colorBtn)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								...
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(imageBtn).addGap(0, 0, Short.MAX_VALUE)))));

		pack();
	}// </editor-fold>//GEN-END:initComponents

	/**
	 * Called when the color button is hit. This method was created by NetBeans.
	 * It can be edited, but it cannot be deleted, nor can you change the method
	 * signature.
	 * 
	 * @param evt
	 *            = information about the button press event. Generally, this
	 *            isn't needed.
	 */
	...
	/**
	 * Called when the rectangle button is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	...
	/**
	 * Called when the square button is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	 * the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the circle button is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	 * the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the ellipse button is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	 * the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the triangle button is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	 * the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the line button is hit. This method was created by NetBeans.
	 * It can be edited, but it cannot be deleted, nor can you change the method
	 * signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the select button is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	 * the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the zoom out button is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	 * the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the zoom in button is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	 * the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the horizontal scrollbar is adjusted. This method was created
	 * by NetBeans. It can be edited, but it cannot be deleted, nor can you
	...
	/**
	 * Called when the vertical scrollbar is adjusted. This method was created
	 * by NetBeans. It can be edited, but it cannot be deleted, nor can you
	 * change the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the house button is hit. This method was created by NetBeans.
	 * It can be edited, but it cannot be deleted, nor can you change the method
	 * signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the Save CS355Image menu item is hit. This method was created
	 * by NetBeans. It can be edited, but it cannot be deleted, nor can you
	 * change the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the Open CS355Image menu item is hit. This method was created
	 * by NetBeans. It can be edited, but it cannot be deleted, nor can you
	 * change the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the Quit menu item is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	 * the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the Brightness menu item is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	 * the method signature.
	 * 
	 * @param evt
		...
		try {
			...
			if (brightnessAmountNum > 100 || brightnessAmountNum < -100) {
				JOptionPane.showMessageDialog(this,
						"That is not a valid number. Please enter a number between -100 and 100.",
			...
			JOptionPane.showMessageDialog(this, "That is not a valid number.", "Unable to change brightness",
					JOptionPane.ERROR_MESSAGE);
		}
	}// GEN-LAST:event_brightnessItemActionPerformed

	/**
	 * Called when the Contrast menu item is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	 * the method signature.
	 * 
	 * @param evt
	...
	private void contrastItemActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_contrastItemActionPerformed
		...
		try {
			...
			JOptionPane.showMessageDialog(this, "That is not a valid number.", "Unable to change contrast",
					JOptionPane.ERROR_MESSAGE);
		}
	}// GEN-LAST:event_contrastItemActionPerformed

	/**
	 * Called when the Uniform Blur menu item is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	 * the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the Median Blur menu item is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	 * the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the Sharpen menu item is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	 * the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the Detect Edges menu item is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	 * the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the image button is hit. This method was created by NetBeans.
	 * It can be edited, but it cannot be deleted, nor can you change the method
	 * signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the Delete Shape menu item is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	 * the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the Move Forward menu item is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	 * the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the Move Backward menu item is hit. This method was created
	 * by NetBeans. It can be edited, but it cannot be deleted, nor can you
	 * change the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the Send to Front menu item is hit. This method was created
	 * by NetBeans. It can be edited, but it cannot be deleted, nor can you
	 * change the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the Send to Back menu item is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	 * the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the Save Drawing menu item is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	 * the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the Open Drawing menu item is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	 * the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the Save Picture menu item is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	 * the method signature.
	 * 
	 * @param evt
	...
	/**
	 * Called when the Open Scene menu item is hit. This method was created by
	 * NetBeans. It can be edited, but it cannot be deleted, nor can you change
	 * the method signature.
	 * 
	 * @param evt
	 ...
	 * 
	 * @param scrollBar
	 *            = the scrollbar that will be changed.
	 * @param attribute
	 *            = the attribute of the scrollbar that will be changed.
	 * @param number
	...
	/**
	 * Changes the selected <i>drawing</i> color. This should be called by the
	 * student's CS355Controller instance.
	 * 
	 * @param c
	...
	/**
	 * Just forward the mouse event to the student's CS355Controller.
	 * 
	 * @param me
	 *            = the captured event.
	 */
	...
	/**
	 * This event means that we have to start updating the coordinate label.
	 * 
	 * @param me
	 *            = the captured event.
	 */
	...
	/**
	 * This event means that we have to stop updating the coordinate label.
	 * 
	 * @param me
	 *            = the captured event.
	 */
	...
	/**
	 * This event means that we have to keep updating the coordinate label.
	 * 
	 * @param me
	 *            = the captured event.
	 */
			...
			while (true) {
				try {
					...
					if (!parent.keysPressed.isEmpty()) {
						// This is to prevent the form from concurrently
						// modifying
