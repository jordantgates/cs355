...
/**
 * A collection of static functions that allow the student's CS355Controller to
 * control the window.
 * 
 * @author Talonos
 */
public class GUIFunctions {
	...
	/**
	 * Refreshes the view by repainting the canvas. Call this any time the
	 * picture in the main view should change.
	 */
	...
	/**
	 * Changes the main view so that the given color is shown in the color
	 * selector box.
	 * 
	 * @param c
	 *            = the color to show in the color selector box.
	 */
	...
	/**
	 * Changes the amount the vertical scrollbar returns when it is all the way
	 * at the top.
	 * 
	 * @param newMin
	 *            = the new value to return when the vertical scrollbar is at
	 *            the top.
	 */
	...
	/**
	 * Changes the amount the horizontal scrollbar returns when it is all the
	 * way at the left.
	 * 
	 * @param newMin
	 *            = the new value to return when the horizontal scrollbar is at
	 *            the left.
	 */
	...
	/**
	 * Changes the amount the vertical scrollbar returns when it is all the way
	 * at the bottom. <b>Important</b>: See {@link #setVScrollBarKnob(int)} for
	...
	/**
	 * Changes the amount the horizontal scrollbar returns when it is all the
	 * way at the left. <b>Important</b>: See {@link #setHScrollBarKnob(int)}
	...
	/**
	 * Sets the width of the scrollbar's knob. This is not just purely visual!
	 * If you have, for example, a knob width of 2 and a maximum value of 4,
	 * then the knob will "fill" the last half of the scroll bar and return a
	 * value of 2 if pushed all the way to the left!
	 * 
	 * @param newKnob
	 *            = the new width of the knob.
	 */
	...
	/**
	 * Sets the position of the scrollbar's knob. This will send an event to the
	 * student's controller!
	 * 
	 * @param newPosit
	 *            = the new position of the knob.
	 */
	 ...
	 * 
	 * @param c
	 *            = the CS355Controller you wish to receive button events.
	 * @param v
	 *            = The view refresher used to draw the canvas.
	 */
	 ...
	 * 
	 * @param zoom
	 *            = the new zoom level that should be printed.
	 */
