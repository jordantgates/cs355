...
public class JsonShape implements JsonSerializer<Shape>, JsonDeserializer<Shape> {
	...
	/**
	 * Used to serialize a shape. It serializes an extra property: the shape
	 * type.
	 * 
	 * @param s
	 *            the shape to serialize.
	 * @param type
	 *            the shape's real type. <b>DO NOT USE THIS!</b> It may result
	 *            in an infinite loop according to Gson documentation.
	 * @param jsc
	 *            = the context that allows us to continue serialization.
	...
	/**
	 * Used to deserialize a shape. It uses the property generated by the
	 * serializer to create the proper shape.
	 * 
	 * @param je
	 *            the current JsonElement that we need to deserialize from.
	 * @param type
	 *            the type of the Shape. <b>DO NOT USE THIS!</b> It may result
	 *            in an infinite loop according to Gson documentation.
	 * @param jdc
	 *            the context that allows us to continue with deserialization.
