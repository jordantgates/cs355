...
/**
 * One instance of a model in a scene, including where the model is and how it's
 * rotated.
 * 
 * @author gavin
 */
public class Instance {
	 ...
	 * @param angle
	 *            the rotation angle of this instance around the y-axis.
	 * @param scale
	 *            the scale of the model.
	 * @param model
	 *            the actual model.
	 ...
	 * 
	 * @param color
	 *            the new color that this Instance should be drawn with.
	 */
	 ...
	 * 
	 * @param pos
	 *            the new 3D position of this Instance.
	 */
	 ...
	 * 
	 * @param scale
	 *            the new scale for this Instance.
	 */
